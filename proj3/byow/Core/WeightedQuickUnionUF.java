 ...
 *  @author Kevin Wayne
 */
public class WeightedQuickUnionUF implements Cloneable {
    private int[] parent;
    private int[] size;
    private int count;
    ...
    @Override
    public WeightedQuickUnionUF clone() {
        try {
            return (WeightedQuickUnionUF) super.clone();
    ...
    public WeightedQuickUnionUF(WeightedQuickUnionUF wqu) {
        this.copy = wqu;
    }
    ...
    public WeightedQuickUnionUF getCopy() {
        return copy;
    }
